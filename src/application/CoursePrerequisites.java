...
public class CoursePrerequisites {
    ...
    public boolean checkPrerequisites(ArrayList<String> selectedClasses) {
        Map<String, Prerequisite> adjacencyList = new HashMap<>();
        ...
        addPrerequisite(adjacencyList, "MATH2300", "OR", Arrays.asList("MATH1500", "MATH1800", "MATH1700"));
        ...
        // Computer Science
        addPrerequisite(adjacencyList, "MATH1876", "OR", Arrays.asList("MATH1776", "MATH1750"));
        ...
        addPrerequisite(adjacencyList, "MATH2025", "OR", Arrays.asList("MATH1850", "MATH1875"));
        ...
        addPrerequisite(adjacencyList, "MATH3900", "AND", Arrays.asList("COMP1000", "MATH1850"));
        ...
        for (String completedCours : selectedClasses) {
            ...
            if (parts.length >= 1) {
                ...
                System.out.print(course + " yo");
            }
        }

        Prerequisite prerequisites = adjacencyList.get(newCourse.get(0));
        for (String course : prerequisites.courses) {
    ...
    private static void addPrerequisite(Map<String, Prerequisite> adjacencyList, String course, String type, List<String> prerequisites) {
        ...
        if (course.equals("MATH2860")) {
            System.out.println("Mapping to: " + course);
            for (String s : prerequisites) {
                System.out.println(s);
            }
            Prerequisite prereq = adjacencyList.get(course);
            for (String cour : prereq.courses) {
